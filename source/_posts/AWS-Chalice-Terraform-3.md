...
Chalice has a built-in test client, located at [`chalice.test.Client`](https://aws.github.io/chalice/api#Client), capable of calling the lambda functions created within the project in multiple ways:
